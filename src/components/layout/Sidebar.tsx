...
import { Home, PieChart, Wallet, Settings, Plus, LayoutDashboard, History, BarChart3, Sparkles, Notebook, ClipboardList } from "lucide-react"
...
const navItems = [
  ...
  { name: "Personal Notes", href: "/notes", icon: ClipboardList },
]
